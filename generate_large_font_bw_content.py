...
<head>
    <meta charset="UTF-8">
    <title>RailBlock-AI B&W Architecture Large Font</title>
    <style>
        ...
        * {
        ...
        /* MAIN CONTENT AREA - OPTIMIZED FOR CANVA 1840x780 ASPECT RATIO */
        .main-content {
            width: 1840px;
            padding: 16px 20px;
            display: flex;
...
html_file = "slide3_bw_large_font.html"
with open(html_file, "w") as f:
    f.write(html_content)

print("Saved slide3_bw_large_font.html")
